...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light container">
        @can('view_painel')
        <a class="navbar-brand" href="{{ route('painel') }}">MenuTable</a>
        @else
        <a class="navbar-brand" href="{{ route('pedidos.index') }}">MenuTable</a>
        @endcan
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('historic') }}">Histórico de pedidos</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('config.client') }}">Configurações</a>
                    </div>
